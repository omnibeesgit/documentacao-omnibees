...
Um tipo de quarto é a unidade básica de uma propriedade/hotel.   
Possui uma quantidade disponível (normalmente, a quantidade física de quartos desse tipo existente no hotel) e algumas características associadas, como amenidades, fotos, etc.

# **Lista de Tipos de Quarto**

Neste ecrã é possível listar todos os Tipos de Quarto da Propriedade.   

![Lista Tipos de Quarto.png](./Documentação Produto - Quartos_files/Lista Tipos de Quarto.png)  
...
Todos os filtros são de texto livre, exceto o filtro 'Cama Extra', que é do tipo booleano.
...
O botão "Eliminar" deve estar visível apenas se um ou mais itens forem selecionados.  
...
User selects “Removed” to list all the Deleted Room Types. 
...
![Criação Tipos de Quarto.png](./Documentação Produto - Quartos_files/Criação Tipos de Quarto.png)  
...
| Máx. Pax.                                            | Não                                                                        | -                     |                                                                                                       |
| Mín. de Adultos                                      | SIM                                                                        | -                     | Números inteiros maiores que 0. O mín. de adultos não pode ter um valor maior que o máx. de adultos. |
| Máx. de Adultos                                      | SIM                                                                        | -                     | Números inteiros maiores que 0. O máx. de adultos não pode ter um valor menor que o mín. de adultos.  |
...
O nome e a descrição podem ser configurados em vários idiomas. O idioma predefinido deve ser o idioma base da propriedade.
...
![Screenshot_491.png](./Documentação Produto - Quartos_files/Screenshot_491.png)  
...
![Screenshot_492.png](./Documentação Produto - Quartos_files/Screenshot_492.png)  

  
If the number of adults or children is decremented, the system should alert the account manager that prices for the removed occupancy will also be removed. The following warning message should be triggered: “Room occupancy changed. Since the occupancy Adult 4 is no longer allowed, prices will be removed. Want to continue? Yes/No.”   

  
Apenas utilizadores com a **permissão** "**Usuário pode editar a ocupação de um tipo de quarto**" _(PermissionCode 5044)_ podem alterar a ocupação de adultos (Mín. de Adultos e Máx. de Adultos) e a ocupação de crianças (Aceitar Crianças, Máx. de Crianças e Máx. de Crianças Grátis).

Gestores de Conta podem editar sempre a ocupação dos quartos, desde que tenham permissão para editar quartos.

Utilizadores com a **permissão** "**Usuário não pode alterar quartos criados por gerente de conta**" _(PermissionCode 543)_ não podem editar quartos que tenham sido criados por gestores de conta, mesmo que tenham permissão para editar quartos. Quartos criados por gestores de conta são mostrados apenas para consulta para estes utilizadores.  
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 120 DC, 120V, 220 DC, 220V, Ar condicionado, Serviço de alarme, Berço de bebê, Varanda, Jornal diário, Desktop, Telefone com linha direta, Fax, Lareira, Acesso à internet, Internet sem fio, Telefone IP, Tábua de passar roupa, Cofre de segurança para laptop, Sala de estar, Sala de reunião, Quarto para não fumantes, Menu de travesseiros, Impressora, Cofre, Quarto para fumantes, Telefone, Terraço, Mesa de trabalho. | Facilidades, Banheira ou Ducha, Roupão de banho, Telefone, Banheira, Bidê, Banheiro privativo, Secador de cabelo, Jacuzzi, Banheiro compartilhado, Chuveiro, Chinelos. | Máquina de café, Talheres, Pratos, Chaleira elétrica, Óculos, Kitchenette, Micro-ondas, Mini-bar, Geladeira, Instalações para chá e café, Torradeira. | TV a cabo, CD Player, DVD Player, Internet, TV de tela Plana / Plasma / LCD, MP3/4 Dockstation, Televisão paga, Playstation, Rádio, Smart TV, TV, Controle remoto, Video Games, Vídeo sob demanda, Xbox. |
...
É possível marcar uma foto como principal (apenas uma foto), através do ícone "estrela" mostrado no *hover* e no *preview* das fotos.

O ícone "estrela" deve incluir uma *tooltip* com a seguinte informação: "Definir como Principal".  

A foto marcada como principal fica marcada com uma "estrela" e será mostrada como foto principal no Motor de Reservas.   

Uma vez definida uma foto como principal no quarto, este já não poderá deixar de ter uma foto marcada como principal. É possível alterar a foto principal, mas não a remover.
...
| -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cama de casal, King, Queen, Sofá-cama, Solteiro King, Solteiro, Variável, Beliche.     | Vista para a Cidade, Vista para o Pátio, Vista para Campo de Golfe, Vista para o Porto, Vista para o Lago, Vista para a Marina, Vista para a Montanha, Vista para o Oceano, Vista para a Piscina, Vista para o Rio, Vista para a Praia, Vista para o Jardim, Vista para o Parque, Vista para a Floresta, Vista variada, Vista para o Campo, Vista para o Mar, Vista Lateral Mar, Vista para estacionamento. | Suites, Apartamentos, Studios, Condomínios, Loft, Bungalow, Villa, Junior suite, Clássica, Luxo, Suíte Deluxe, Econômica, Luxury, Standard, Superior, Executiva, Villa for 1. |


As opções 'Compartilhar', 'URL Motor de Reservas' e 'Histórico de Alterações' são mostradas apenas na edição. Na criação do quarto, estas opções não estão disponíveis.  
  
As opções 'Compartilhar' e 'URL Motor de Reservas' são mostradas apenas mediante permissão (ação "Ligado" na permissão para o ecrã).
...
São listadas todas as tarifas e pacotes (não eliminadas) de hotel e todas as tarifas e pacotes multi-property (não eliminadas) que estão associadas ao hotel.  

_Nota_: Na lista de tarifas só são mostradas tarifas Omnibees; não podem ser mostradas tarifas de extranets.
...
O mesmo deve acontecer ao remover uma tarifa/pacote de um tipo de quarto. Ao realizar esta ação e guardar, é mostrada uma mensagem ao utilizador para que ele se certifique de que fechou vendas _(mesma regra existente quando se remove um quarto em 'Tarifas')._
...
![Screenshot_366.png](./Documentação Produto - Quartos_files/Screenshot_366.png)  
...
Ao eliminar um Tipo de Quarto, serão também eliminados toda a multimédia do quarto e o tipo de quarto na tabela de Dependência de Tipos de Quarto, se aplicável.
...
Sempre que forem eliminados Tipos de Quarto que estejam associados a pelo menos uma tarifa/pacote, deve ser mostrada uma mensagem para que o utilizador se certifique de que fechou vendas _(mesma regra existente quando se remove um quarto em 'Tarifas')._
