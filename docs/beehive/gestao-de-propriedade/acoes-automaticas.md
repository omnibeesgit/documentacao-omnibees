...
description: Este documento detalha a configuração de Ações Automáticas, e-mails personalizados enviados pelo sistema em resposta a eventos específicos como novas reservas, alterações, cancelamentos, pré/pós-estadia e erros de canal/PMS.
...
O painel de Ações Automáticas deve validar a permissão com o código 358, ou seja, apenas o utilizador que tenha essa permissão consegue aceder a este painel.
...
O utilizador deve preencher todos os campos obrigatórios e **salvar**.
